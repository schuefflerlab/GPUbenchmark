...
parser.add_argument(
    "--device", type=int, default=2, help="Device to train on. Example: cuda:0"
)
parser.add_argument(
...
configurations = [
    {"dtype": "fp32", "batch_size": 512,"epochs": 20},
...
def parse_output(output):
    ...
    return {
        ...
        "samples_per_sec": "no sample speed is recorded, because eval is inclusive",
    }
